...
- **Chart version:** `0.1.8`
- **App image (appVersion):** `26.8.1.14`
...
helm repo update
helm search repo lighthouse          # shows CHART 0.1.8 / APP 26.8.1.14
helm install l8e letpeoplework/lighthouse --version 0.1.8 -f values-enterprise.yaml
```
