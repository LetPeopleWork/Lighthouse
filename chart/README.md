...
helm repo update
helm search repo lighthouse          # shows CHART 0.1.9 / APP 26.8.3.8
helm install l8e letpeoplework/lighthouse --version 0.1.9 -f values-enterprise.yaml
```
