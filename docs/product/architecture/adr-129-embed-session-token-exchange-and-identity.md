...
> **Superseded 2026-08-06.** The premise below — that a framed Lighthouse cannot complete an
> interactive login, so the identity must come from somewhere that is not the viewer — was removed by
