...
> **Addendum (2026-05-23):** The FE rule-condition interface (formerly `IDeliveryRuleCondition`) was renamed to `IWorkItemRuleCondition` alongside the backend rename. Same shape; same evaluator semantics. See the rename commit.
