    ...
    public sealed class LighthouseProjectTools : LighthouseToolsBase
    {
        ...
        public string GetProjectByName(string name)
        {
            using (var scope = CreateServiceScope())
            {
                ...
                return ToJson(new
                {
                    ...
                    project.FeatureOwnerAdditionalFieldDefinitionId,
                    project.SizeEstimateAdditionalFieldDefinitionId,
                    project.ParentOverrideAdditionalFieldDefinitionId,
        ...
        public string RunProjectWhenForecast(string projectName)
        {
            using (var scope = CreateServiceScope())
            {
                ...
                var remainingWork = featuresWithWork.Sum(f => f.Size);
