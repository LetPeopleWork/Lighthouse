...
#pragma warning restore S107
    {
        ...
        public ActionResult<IEnumerable<PercentilesOverTimeSnapshotDto>> GetPercentilesOverTime(int portfolioId, [FromQuery] int? horizon, [FromQuery] MetricType metricType = MetricType.CycleTime, [FromQuery] DateTime? startDate = null, [FromQuery] DateTime? endDate = null)
        {
            ...
            return this.GetEntityByIdAnExecuteAction(portfolioRepository, portfolioId, (portfolio) =>
                percentilesOverTimeSeriesQuery
                    .GetSeries(portfolioId, OwnerType.Portfolio, metricType, horizon, AsRecordedDay(startDate), AsRecordedDay(endDate))
        ...
        public ActionResult<IEnumerable<ProcessBehaviorSnapshotDto>> GetProcessBehaviorOverTime(int portfolioId, [FromQuery] ProcessBehaviorMetricType type = ProcessBehaviorMetricType.Throughput, [FromQuery] DateTime? startDate = null, [FromQuery] DateTime? endDate = null)
        {
            ...
            return this.GetEntityByIdAnExecuteAction(portfolioRepository, portfolioId, (portfolio) =>
                processBehaviorSeriesQuery
                    .GetSeries(portfolioId, OwnerType.Portfolio, type, AsRecordedDay(startDate), AsRecordedDay(endDate))
        ...
        // compare it against the reconstructed membership count. A divergence signals a capture gap and must
        // never be silent — surface it as a structured warning.
