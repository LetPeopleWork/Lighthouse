...
namespace Lighthouse.Backend.Services.Implementation.Repositories
{
    public class OptionalFeatureRepository : RepositoryBase<OptionalFeature>
    {
        ...
        private void SeedAppSettings()
        {
            ...
            AddIfNotExists(new OptionalFeature { Id = 2, Key = OptionalFeatureKeys.McpServerKey, Name = "MCP Server", Description = "Enables MCP Server to integrate with AI Agents (requires restart). [Premium Only]", Enabled = false, IsPreview = false });
