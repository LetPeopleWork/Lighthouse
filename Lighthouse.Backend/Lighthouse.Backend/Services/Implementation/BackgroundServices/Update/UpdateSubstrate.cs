...
{
    // The four ports that answer differently depending on whether Lighthouse runs as one process or
    ...
    public sealed class UpdateSubstrate(
        ...
        IUpdateCancellationNotifier cancellationNotifier)
    {
        ...
        public IUpdateCancellationNotifier CancellationNotifier => cancellationNotifier;
    }
}
