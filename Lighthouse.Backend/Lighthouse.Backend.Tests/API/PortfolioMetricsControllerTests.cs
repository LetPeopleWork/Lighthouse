...
namespace Lighthouse.Backend.Tests.API
{
    ...
    public class PortfolioMetricsControllerTests
    {
        ...
        public void Setup()
        {
            ...
            featureBlockedTransitionRepositoryMock = new Mock<IFeatureBlockedTransitionRepository>();
            featureBlockedTransitionRepositoryMock
                .Setup(repo => repo.GetOpenSpellsForPortfolio(It.IsAny<int>()))
                .Returns(new Dictionary<int, FeatureBlockedTransition>());
            featureBlockedTransitionRepositoryMock
                .Setup(repo => repo.GetBlockedTransitionsAt(It.IsAny<int>(), It.IsAny<DateOnly>()))
                .Returns([]);
            featureBlockedTransitionRepositoryMock
        ...
        public void GetBlockedCountHistory_PortfolioExists_ReturnsSnapshots()
        {
            ...
            // plus the unrecorded days carrying the last known count forward (7/3–7/5 = 8).
            ...
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(dtos[1].BlockedCount, Is.EqualTo(8));
                Assert.That(dtos[4].RecordedAt, Is.EqualTo("2026-07-05"));
                Assert.That(dtos[4].BlockedCount, Is.EqualTo(8));
            }
        }
        ...
        public void GetBlockedCountHistory_MissingDaysBetweenSnapshots_CarriesForwardLastKnownCount()
        {
            ...
            var snapshots = new List<BlockedCountSnapshot>
            {
                new() { Id = 1, OwnerId = 1, OwnerType = OwnerType.Portfolio, RecordedAt = new DateOnly(2026, 7, 3), BlockedCount = 3 },
                new() { Id = 2, OwnerId = 1, OwnerType = OwnerType.Portfolio, RecordedAt = new DateOnly(2026, 7, 6), BlockedCount = 5 },
            };
            blockedCountSnapshotRepositoryMock
                .Setup(x => x.GetAllByPredicate(It.IsAny<Expression<Func<BlockedCountSnapshot, bool>>>()))
                .Returns(snapshots.AsQueryable());
        ...
        public void GetBlockedCountHistory_NoSnapshotOnRangeStart_SeedsFromLatestSnapshotBeforeStart()
        {
            ...
            blockedCountSnapshotRepositoryMock
                .Setup(x => x.GetLatestAtOrBefore(1, OwnerType.Portfolio, new DateOnly(2026, 7, 2)))
                .Returns(new BlockedCountSnapshot { Id = 1, OwnerId = 1, OwnerType = OwnerType.Portfolio, RecordedAt = new DateOnly(2026, 7, 1), BlockedCount = 2 });
        ...
        public void GetBlockedCountHistory_NoSnapshotBeforeStart_BeginsAtFirstInRangeSnapshot()
        {
            ...
            var snapshots = new List<BlockedCountSnapshot>
            {
                new() { Id = 1, OwnerId = 1, OwnerType = OwnerType.Portfolio, RecordedAt = new DateOnly(2026, 7, 5), BlockedCount = 4 },
                new() { Id = 2, OwnerId = 1, OwnerType = OwnerType.Portfolio, RecordedAt = new DateOnly(2026, 7, 6), BlockedCount = 5 },
            };
            blockedCountSnapshotRepositoryMock
                .Setup(x => x.GetAllByPredicate(It.IsAny<Expression<Func<BlockedCountSnapshot, bool>>>()))
        ...
        public void GetBlockedCountHistory_SnapshotOnlyOnEndDay_ReturnsSingleRow()
        {
            ...
            var snapshots = new List<BlockedCountSnapshot>
            {
                new() { Id = 1, OwnerId = 1, OwnerType = OwnerType.Portfolio, RecordedAt = new DateOnly(2026, 7, 6), BlockedCount = 5 },
            };
            blockedCountSnapshotRepositoryMock
                .Setup(x => x.GetAllByPredicate(It.IsAny<Expression<Func<BlockedCountSnapshot, bool>>>()))
                .Returns(snapshots.AsQueryable());
