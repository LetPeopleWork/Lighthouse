...
namespace Lighthouse.Backend.Tests.Architecture
{
    ...
    public class BackendTestParallelizationGuardTest
    {
        private static readonly IReadOnlyDictionary<string, string> AllowedSerialFixtures = new Dictionary<string, string>
        {
            ...
            ["UsageDataEventCeilingTests"] = "saturates the event ingest limiter and exhausts the per-day event allowance on purpose; both are process-wide and nothing resets them, so a parallel neighbour would be refused or dropped",
