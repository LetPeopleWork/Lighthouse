...
namespace Lighthouse.Backend.Tests.Factories
{
    public class IssueFactoryTest
    {
        ...
        public void SetUp()
        {
            ...
            workItemQueryOwner.ToDoStates = toDoStates;
            workItemQueryOwner.DoingStates = doingStates;
            workItemQueryOwner.DoneStates = doneStates;
        ...
        public void CreateIssue_NoKeyAvailable_Throws()
        {
            ...
            Assert.Throws<KeyNotFoundException>(() => CreateIssueFactory().CreateIssueFromJson(jsonDocument.RootElement, workItemQueryOwner));
        }
