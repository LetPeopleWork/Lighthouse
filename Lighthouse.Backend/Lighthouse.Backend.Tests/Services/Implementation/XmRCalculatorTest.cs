...
namespace Lighthouse.Backend.Tests.Services.Implementation
{
    public class XmRCalculatorTest
    {
        ...
        {
            var baseline = Array.Empty<double>();
            var display = new[] { 1.0, 2.0 };
        ...
        {
            var baseline = new[] { 5.0 };
            var display = new[] { 5.0, 8.0 };
        ...
        public void Calculate_ComputesAverageFromBaselineOnly()
        {
            ...
            var baseline = new[] { 10.0, 20.0, 30.0, 40.0 };
            var display = new[] { 100.0 };
        ...
        public void Calculate_AllIdenticalBaselineValues_ProducesZeroRangeLimits()
        {
            ...
            var baseline = new[] { 5.0, 5.0, 5.0, 5.0, 5.0 };
            var display = new[] { 5.0, 6.0 };
        ...
        public void Calculate_LargeChange_PointBeyondUnpl()
        {
            ...
            var baseline = new[] { 10.0, 10.0, 10.0, 10.0 };
            var display = new[] { 50.0 };
        ...
        public void Calculate_LargeChange_PointBelowLnpl()
        {
            ...
            var baseline = new[] { 100.0, 110.0, 100.0, 110.0 };
            var display = new[] { 50.0 };
        ...
        public void Calculate_SmallShift_EightConsecutiveAboveAverage()
        {
            ...
            var baseline = new[] { 40.0, 60.0, 40.0, 60.0, 40.0, 60.0, 40.0, 60.0 };
            var display = new[] { 55.0, 55.0, 55.0, 55.0, 55.0, 55.0, 55.0, 55.0 };
        ...
        {
            var baseline = new[] { 40.0, 60.0, 40.0, 60.0, 40.0, 60.0, 40.0, 60.0 };
            var display = new[] { 45.0, 45.0, 45.0, 45.0, 45.0, 45.0, 45.0, 45.0 };
        ...
        public void Calculate_ModerateShift_FourOfFiveBeyondOneSigma()
        {
            ...
            var baseline = new[] { 40.0, 60.0, 40.0, 60.0, 40.0, 60.0, 40.0, 60.0 };
            var display = new[] { 70.0, 70.0, 70.0, 50.0, 70.0 };
        ...
        public void Calculate_ModerateChange_TwoOfThreeBeyondTwoSigma()
        {
            ...
            var baseline = new[] { 40.0, 60.0, 40.0, 60.0, 40.0, 60.0, 40.0, 60.0 };
            var display = new[] { 90.0, 50.0, 90.0 };
        ...
        public void Calculate_HigherPriorityRuleWins_LargeChangeOverModerateChange()
        {
            ...
            var display = new[] { 110.0, 50.0, 110.0 };
        ...
        public void Calculate_DisjointBaselineAndDisplay_UsesBaselineForStatistics()
        {
            ...
            var display = new[] { 25.0, 30.0, 60.0 };
        ...
        {
            var baseline = new[] { 10.0, 20.0, 30.0, 40.0 };
            var display = new[] { 25.0, 30.0, 35.0, 40.0, 45.0 };
        ...
        public void Calculate_TwoBaselineValues_ComputesLimitsFromSingleMovingRange()
        {
            ...
            var baseline = new[] { 10.0, 20.0 };
            var display = new[] { 15.0 };
        ...
        public void Calculate_ClassificationsAppliedToDisplayValues()
        {
            ...
            var baseline = new[] { 10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0, 10.0 };
            var display = new[] { 10.0, 10.0, 10.0, 10.0, 10.0 };
