...
namespace Lighthouse.Backend.Migrations
{
    ...
    [Migration("20240726105748_AddAppSettingToDb")]
    partial class AddAppSettingToDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lighthouse.Backend.Models.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Key = "PeriodicRefresh:Throughput:Interval",
                            Id = 0,
                            Value = "60"
                        },
                        new
                        {
                            Key = "PeriodicRefresh:Throughput:RefreshAfter",
                            Id = 0,
                            Value = "180"
                        },
                        new
                        {
                            Key = "PeriodicRefresh:Throughput:StartDelay",
                            Id = 0,
                            Value = "1"
                        },
                        new
                        {
                            Key = "PeriodicRefresh:Features:Interval",
                            Id = 0,
                            Value = "60"
                        },
                        new
                        {
                            Key = "PeriodicRefresh:Features:RefreshAfter",
                            Id = 0,
                            Value = "180"
                        },
                        new
                        {
                            Key = "PeriodicRefresh:Features:StartDelay",
                            Id = 0,
                            Value = "2"
                        },
                        new
                        {
                            Key = "PeriodicRefresh:Forecasts:Interval",
                            Id = 0,
                            Value = "60"
                        },
                        new
                        {
                            Key = "PeriodicRefresh:Forecasts:RefreshAfter",
                            Id = 0,
                            Value = "180"
                        },
                        new
                        {
                            Key = "PeriodicRefresh:Forecasts:StartDelay",
                            Id = 0,
                            Value = "5"
                        });
                });
