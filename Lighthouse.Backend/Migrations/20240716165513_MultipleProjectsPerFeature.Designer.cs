...
namespace Lighthouse.Backend.Migrations
{
    ...
    [Migration("20240716165513_MultipleProjectsPerFeature")]
    partial class MultipleProjectsPerFeature
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lighthouse.Backend.WorkTracking.WorkTrackingSystemOption<Lighthouse.Backend.Models.Project>", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Lighthouse.Backend.WorkTracking.WorkTrackingSystemOption<Lighthouse.Backend.Models.Team>", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Lighthouse.Backend.WorkTracking.WorkTrackingSystemOption<Lighthouse.Backend.Models.Project>", b =>
                {
                    b.HasOne("Lighthouse.Backend.Models.Project", "Entity")
            ...
            modelBuilder.Entity("Lighthouse.Backend.WorkTracking.WorkTrackingSystemOption<Lighthouse.Backend.Models.Team>", b =>
                {
                    b.HasOne("Lighthouse.Backend.Models.Team", "Entity")
                        .WithMany("WorkTrackingSystemOptions")
                        .HasForeignKey("EntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
