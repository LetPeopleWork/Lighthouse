...
> - `adr-001 … adr-198` — point decisions (in that folder). The index at the end maps the load-bearing ones, and says which are designed but not built.
>
