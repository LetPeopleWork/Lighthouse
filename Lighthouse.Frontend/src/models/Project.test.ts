...
describe('Project Class', () => {
    ...
    beforeEach(() => {
        ...
        const feature1 = new Feature('Feature 1', 1, new Date('2023-07-10'), 1, name, { 1: 10, 2: 20 }, { 0: 88.7 }, [
            new WhenForecast(0.8, new Date('2023-08-01')),
        ]);
        const feature2 = new Feature('Feature 2', 2, new Date('2023-07-09'), 1, name, { 1: 5, 2: 15 }, { 0: 54.3 }, [
