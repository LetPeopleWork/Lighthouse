...
describe('Team Class', () => {
    ...
    beforeEach(() => {
        ...
        const feature1 = new Feature('Feature 1', 1, "", new Date('2023-07-10'), { 1: "Project 1" }, { 1: 10, 2: 20 }, { 1: 10, 2: 20 }, {}, [
            new WhenForecast(0.8, new Date('2023-08-01')),
        ]);
        const feature2 = new Feature('Feature 2', 2, "", new Date('2023-07-09'), { 2: "Project 2" }, { 1: 5, 2: 15 }, { 1: 5, 2: 15 }, {}, [
