		...
		<Dialog open={open} onClose={onClose}>
			...
			<DialogContent>
				<DialogContentText>
					...
					<Typography variant="body1">
						Lighthouse is an open source application and provided free of
						charge. Go to{" "}
						<Link to={"https://github.com/LetPeopleWork/Lighthouse"}>
							GitHub
						</Link>{" "}
						to find instructions on how to run it yourself. If you want more
						information, guidance on how to use the tool or would like to see a
						guided demo, reach out via{" "}
						<Link to={"https://letpeople.work"}>letpeople.work</Link>.
					</Typography>
				</DialogContentText>
			</DialogContent>
			<DialogActions>
