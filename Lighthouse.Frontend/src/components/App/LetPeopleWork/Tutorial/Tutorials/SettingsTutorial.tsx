...
Each connection has a specific name and a type. Depending on the type, different configuration options have to be specified.`}
            ...
            <InputGroup initiallyExpanded={false} title="Jira">
                ...
                <Typography variant="body1">
                    ...
                    <Link to="https://support.atlassian.com/atlassian-account/docs/manage-api-tokens-for-your-atlassian-account/" target="_blank" rel="noopener">
...
On top of that, you need to specify a `}
                    <Link to="https://learn.microsoft.com/en-us/azure/devops/organizations/accounts/use-personal-access-tokens-to-authenticate?view=azure-devops&tabs=Windows" target="_blank" rel="noopener">
...
const steps = [
    ...
    { title: 'Periodic Refresh Settings', component: PeriodicRefreshSettingsStep },
