...
interface WorkItemAgePercentilesProps {
	percentileValues: IPercentileValue[];
}

const WorkItemAgePercentiles: React.FC<WorkItemAgePercentilesProps> = ({
	percentileValues,
}) => {
	...
	const hasWorkInProgress = percentileValues.some((item) => item.value > 0);
...
export default WorkItemAgePercentiles;
