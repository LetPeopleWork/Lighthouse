...
vi.mock('../../../pages/Teams/Edit/AdvancedInputs', () => ({
    __esModule: true,
    default: ({ onTeamSettingsChange }: { onTeamSettingsChange: (key: keyof ITeamSettings, value: string) => void }) => (
        <div>
            <div>AdvancedInputsComponent</div>
            <button onClick={() => onTeamSettingsChange('name', 'value')}>Change Advanced</button>
        </div>
    ),
}));
...
vi.mock('../../../pages/Teams/Edit/GeneralInputs', () => ({
    ...
    default: ({ onTeamSettingsChange }: { onTeamSettingsChange: (key: keyof ITeamSettings, value: string) => void }) => (
        <div>
            ...
            <button onClick={() => onTeamSettingsChange('name', 'value')}>Change General</button>
        </div>
    ),
}));
