...
describe("TimeInStateBadge", () => {
	...
	test.each([
		["2026-05-25T00:00:00Z", "0d in In Progress"],
		["2026-05-24T00:00:00Z", "1d in In Progress"],
		["2026-05-23T23:00:00Z", "2d in In Progress"],
		["2026-05-15T12:00:00Z", "10d in In Progress"],
	])("renders whole days in current state for entered date %s", (enteredAt, expectedText) => {
		render(
			<TimeInStateBadge
