...
describe('ProjectCard component', () => {
  const project: Project = new Project(
    ...
    [new Feature('Feature', 0, "", new Date(), { 1: "Project Alpha" }, { 1: 7, 2: 3 }, { 1: 7, 2: 3 }, { 0: 74.5 }, [new WhenForecast(50, new Date("2025-08-04")), new WhenForecast(70, new Date("2025-06-25")), new WhenForecast(85, new Date("2025-07-25")), new WhenForecast(95, new Date("2025-08-19"))])],
