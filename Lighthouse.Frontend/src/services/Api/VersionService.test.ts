...
describe('VersionService', () => {
    ...
    it('should get new releases', async () => {
        const mockReleases: ILighthouseRelease[] = [
            new LighthouseRelease("Release 1", "http://example.com/release1",  "Feature 1", "1.0.1", [new LighthouseReleaseAsset("Asset 1", "http://example.com/asset1")]),
            new LighthouseRelease("Release 2", "http://example.com/release2",  "Feature 2", "1.0.2", [new LighthouseReleaseAsset("Asset 2", "http://example.com/asset2")]),
        ];
