 ...
 */
const namedForUsageData: ReadonlyMap<string, UsageDataOptionalFeature> =
	new Map([["FeatureOrdering", UsageDataOptionalFeature.FeatureOrder]]);

export const usageDataOptionalFeatureFor = (
	key: string,
): UsageDataOptionalFeature | undefined => namedForUsageData.get(key);
